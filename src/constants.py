...
## LEVEL 1
LVL1_LAYOUT = os.path.join(os.path.dirname( __file__ ),"..", "images\maps\LevelOne", "DM.csv")
LEVELONE_BACKIMAGE = os.path.join(os.path.dirname( __file__ ),"..", "images\maps\LevelOne", "map.png")
LEVEL1_REWARD = 100
